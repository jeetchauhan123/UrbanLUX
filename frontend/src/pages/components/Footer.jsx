                        ...
                        <div className="w-10/12 flex flex-row justify-evenly">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-row gap-2">
                                    <button className="border px-3 py-1 rounded-md hover:bg-[#e7e7fc] hover:text-[#3a1051]">
                                        Send
                                    </button>
                                    <input
                                        type="email"
                                        name="email"
                                        id="email"
                                        className="bg-[#9ccaff38] rounded-sm"
                                    />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="flex flex-row gap-2">
                                    ...
                                    <Link to={"https://apps.apple.com/app/"}>
                                        <img src="./app-store.png" alt="app-store" className="h-15" />
                                    </Link>
                                </div>
                            </div>
                            <div className="flex flex-row gap-2">
